...
class WordFamilyClusterer:
    ...
    def cluster_lemma(
        ...
        Args:
            ...
            extra_instruction: Optional extra line for prompt (e.g. "When meaning matches WordNet sense, use it")
        ...
        if len(examples) <= MAX_EXAMPLES_PER_BATCH:
            return self._cluster_single_batch(
                lemma, examples, sentence_ids, wordnet_hints, extra_instruction
            )
    ...
    def _cluster_multi_pass(
        ...
        for batch_idx in range(num_batches):
            ...
            result = self._cluster_single_batch(
                lemma, batch_examples, batch_ids, wordnet_hints, extra_instruction
            )
