...
def manual_check_samples():
    ...
    for idx, row in valid_cards.iterrows():
        ...
        card_row = cards_df[
            (cards_df["lemma"] == lemma) & (cards_df["primary_synset"] == primary_synset)
        ]
        ...
        print(
            f"Валидных: {len(validation['valid_sentence_ids'])}, "
    ...
    print("   (valid/invalid) для сравнения с результатами LLM")
    print("=" * 80)
