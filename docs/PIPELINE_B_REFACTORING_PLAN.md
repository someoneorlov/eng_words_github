...
**Decision points (правило “target в примерах”, контракции, headword, QC thresholds):** зафиксированы в `docs/PIPELINE_B_QUALITY_DECISIONS.md` — использовать при реализации и ревью.
