...
class TestValidateCardExamples:
    ...
    def invalid_card(self):
        ...
        return SmartCard(
            ...
            translation_ru="размышлять мрачно",
...
class TestExtendedIrregularForms:
    ...
    def test_extended_forms_coverage(self):
        ...
        standard_verbs = [
            "beat", "bend", "bet", "bid", "bite", "bleed", "breed", "burn",
            "burst", "cast", "cost", "creep", "deal", "dig", "dream", "drink",
            "eat", "feed", "fight", "flee", "fling", "fly", "forbid", "forecast",
            "forgive", "freeze", "grind", "hide", "hit", "kneel", "knit",
            "lend", "light", "mislay", "mislead", "prove", "quit", "rid",
            "ride", "ring", "saw", "seek", "sew", "shear", "shed", "shine",
            "shoe", "shoot", "show", "shrink", "shut", "sing", "sink",
            "slay", "sleep", "slide", "sling", "slink", "slit", "smell",
            "smite", "sow", "spell", "spill", "spit", "split", "spoil",
            "spread", "steal", "stick", "sting", "stink", "strew", "stride",
            "string", "strive", "swear", "swim", "teach", "tear", "thrive",
            "thrust", "tread", "undergo", "undertake", "undo", "upset",
            "wake", "weave", "wed", "weep", "wet", "win", "wind",
